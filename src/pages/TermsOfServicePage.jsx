...
export default function TermsOfServicePage() {
  ...
  return (
    <div className="min-h-screen bg-[#fff8f6] pb-16">
      {/* Top App Bar */}
      <header className="bg-[#fff8f6] sticky top-0 z-40 border-b border-[#e1bfb5]/20 backdrop-blur-md">
      ...
      <main className="max-w-4xl mx-auto px-4 mt-8">
        <div className="bg-white p-6 md:p-10 rounded-3xl modern-tactile-card border border-[#f7ddd5] space-y-8">
          ...
          <section className="space-y-4">
            ...
            <div className="pl-8 text-[15px] text-[#594139] leading-relaxed animate-fade-in">
              <p>
