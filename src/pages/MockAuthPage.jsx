      ...
      <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 font-sans">
        <div className="w-full max-w-[450px] bg-white border border-slate-200 rounded-lg shadow-md p-8 relative overflow-hidden">
          ...
          <div className="text-center space-y-2 mb-8">
            ...
            <p className="text-sm text-slate-600">to continue to <strong className="text-slate-800">Food Genie</strong></p>
          </div>
          ...
          <div className="p-6 md:p-8 space-y-6">
            <div className="flex gap-4 items-center">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-slate-500 mt-0.5">Food Genie is requesting access to your account.</p>
              </div>
            </div>
